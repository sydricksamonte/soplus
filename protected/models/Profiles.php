...
class Profiles extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('user_id, Emp_Code, FirstName, MI, LastName, Level, Passwrd, AcctName, Bday, LocalNo, CellPhone, Email, TermsConditions, Position, Resigned, PRFPLUS, Optimal, ServiceCtr, Unison, LogIn, LastLog, Sex, religion, citizenship, civilstatus, completeaddress', 'safe', 'on'=>'search'),
		);
	}
