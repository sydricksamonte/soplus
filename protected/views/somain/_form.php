...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div style="border:1px solid green; height:65%; width:65%;padding:2px;" align="left">
	...
	<div class="column" style="padding:5px;">
		<?php echo $form->labelEx($model,'ForApproval'); ?>
		<?php echo $form->checkBox($model,'ForApproval'); ?>
...
<div class="row">
	...
	<div class="row">
		<?php echo $form->labelEx($model,'CancelDateFax'); ?>
	...
	<div class="row">
		<?php echo $form->labelEx($model,'ApprovedDateTime'); ?>
